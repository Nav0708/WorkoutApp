...
//
// void main() {
//   final testExercise = Exercise(exerciseName: 'Push-ups', targetOutput:20, unitMeasurement: 'reps', id: 2);
//   final workoutPlan = WorkoutPlan(workoutPlan:'Saturday morning workout',exerciseList: [testExercise], wp_id: 1);
//
...
//         child: MaterialApp(home: WorkoutRecordingPage(selectedWorkoutPlan: workoutPlan)),
//       ),
//     );
//
//
